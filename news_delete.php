...
<div id="left-col">
        ...
        <?php 
			echo '<p style="text-align:center; color: red;"> <b> ARE YOU SURE YOU WANT TO DELETE THIS NEWS ITEM (PHOTOS ASOCIATED WITH THIS ITEM WILL ALSO BE DELETED) ? (<a href="news_delete_process.php?id='.$news_id.'">YES</a>/<a href="form_list.php">NO</a>) </b> </p>' ;
		?>
